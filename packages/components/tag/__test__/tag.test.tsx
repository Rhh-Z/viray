...
describe('Tag.vue', () => {
  test('render text & class', () => {
    ...
    // expect(vm.$el.classList.contains('vi-tag')).toEqual(true)
    // expect(vm.$el.classList.contains('vi-tag__close')).toEqual(false)
  ...
  //   const vm = wrapper.vm
  //   expect(vm.$el.classList.contains('vi-tag--success')).toEqual(true)
  // })
  ...
  //   const closeBtn = comp.find('.vi-tag .vi-tag__close')
  ...
  //   const vm = wrapper.vm
  //   const el = vm.$el
  //   expect(el.className.includes('vi-tag--dark')).toEqual(true)
  //   expect(el.className.includes('vi-tag--light')).toEqual(false)
  //   expect(el.className.includes('vi-tag--plain')).toEqual(false)
  // })
  ...
  //   const vm = wrapper.vm
  //   const el = vm.$el
  //   expect(el.className.includes('vi-tag--large')).toEqual(true)
  //   expect(el.className.includes('vi-tag--default')).toEqual(false)
  //   expect(el.className.includes('vi-tag--small')).toEqual(false)
  // })
})
